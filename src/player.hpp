...
*/
Player(shared_ptr<Entity_Physics> physics, shared_ptr<Drawer> drawer,kinematic_dynamic_properties* initial_properties, int collision_group, vector<pair<int,bool>> target_collision_groups, aabb_bounds* bound_data, Render_Matrix* render_matrix, int render_layer) 
