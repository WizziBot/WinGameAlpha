...
*/
Player(shared_ptr<Entity_Physics> physics, shared_ptr<Drawer> drawer,kinematic_dynamic_properties* initial_properties, int collision_group, vector<pair<int,bool>> target_collision_groups, aabb_bounds* bound_data, shared_ptr<Render_Matrix> render_matrix, int render_layer) 
: Kinematic_Object(physics,initial_properties,collision_group,bound_data,target_collision_groups), Render_Object(drawer, render_matrix, render_layer, true), restricted_dir(0) {};
